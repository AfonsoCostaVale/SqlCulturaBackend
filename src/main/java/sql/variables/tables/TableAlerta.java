...
public class TableAlerta {
	...
	public static final String[] TABLE_ALERTA = {
	        ...
	        "CONSTRAINT FK2_"+TABLE_ALERTA_COLLUMS[1]+" FOREIGN KEY (" + TABLE_ALERTA_COLLUMS[1] + ") REFERENCES " + TableZona.TABLE_ZONA_NAME     +"(" + TABLE_ALERTA_COLLUMS[1] + ") ON UPDATE CASCADE ON DELETE SET NULL ",
	        "CONSTRAINT FK_" +TABLE_ALERTA_COLLUMS[2]+" FOREIGN KEY (" + TABLE_ALERTA_COLLUMS[2] + ") REFERENCES " + TableSensor.TABLE_SENSOR_NAME       +"(" + TABLE_ALERTA_COLLUMS[2] + ") ON UPDATE CASCADE ON DELETE SET NULL ",
	        "CONSTRAINT FK2_"+TABLE_ALERTA_COLLUMS[7]+" FOREIGN KEY (" + TABLE_ALERTA_COLLUMS[7] + " ) REFERENCES " + TableUtilizador.TABLE_UTILIZADOR_NAME +"(" + TABLE_ALERTA_COLLUMS[7] + ") ON UPDATE CASCADE ON DELETE SET NULL ",
	        "CONSTRAINT FK_" +TABLE_ALERTA_COLLUMS[9]+" FOREIGN KEY (" + TABLE_ALERTA_COLLUMS[9] + " ) REFERENCES " + TableParametroCultura.TABLE_PARAMETROCULTURA_NAME +"(" + TABLE_ALERTA_COLLUMS[9] + ") ON UPDATE CASCADE ON DELETE SET NULL ",
	};
