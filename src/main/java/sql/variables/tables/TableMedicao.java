...
public class TableMedicao {
	...
	public static final String[] TABLE_MEDICAO = {
	        ...
	        "CONSTRAINT FK3_" + TABLE_MEDICAO_COLLUMS[1] + " FOREIGN KEY (" + TABLE_MEDICAO_COLLUMS[1] + ") REFERENCES " + TableZona.TABLE_ZONA_NAME + "(" + TABLE_MEDICAO_COLLUMS[1] + ") ON UPDATE CASCADE ON DELETE SET NULL ",
	        "CONSTRAINT FK2_" + TABLE_MEDICAO_COLLUMS[2] + " FOREIGN KEY (" + TABLE_MEDICAO_COLLUMS[2] + ") REFERENCES " + TableSensor.TABLE_SENSOR_NAME + "(" + TABLE_MEDICAO_COLLUMS[2] + ") ON UPDATE CASCADE ON DELETE SET NULL "
	};
