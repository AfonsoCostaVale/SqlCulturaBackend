...
public class CulturaDB {
    ...
    */
    ...
    private static void createAdminRole(Connection connection) throws SQLException {
        ...
        grantPermissionRole(connection, TableUtilizador.ROLE_ADMIN,"EXECUTE", TableCultura.SP_ATRIBUIR_INVESTIGADOR_CULTURA_NAME,true);
        grantPermissionRole(connection, TableUtilizador.ROLE_ADMIN,"EXECUTE", TableCultura.SP_REMOVER_INVESTIGADOR_CULTURA_NAME,true);
    }
